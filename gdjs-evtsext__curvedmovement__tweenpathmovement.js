...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement = class TweenPathMovement extends gdjs.RuntimeBehavior {
  ...
  getNetworkSyncData() {
    ...
    FlipXToGoBack: this._behaviorData.FlipXToGoBack,
    FlipYToGoBack: this._behaviorData.FlipYToGoBack,
    ...
    Target: this._behaviorData.Target,
    Origin: this._behaviorData.Origin,
    ...
    ShouldGoBack: this._behaviorData.ShouldGoBack,
    ShouldLoop: this._behaviorData.ShouldLoop,
    RepetitionDoneCount: this._behaviorData.RepetitionDoneCount,
    IsGoingBack: this._behaviorData.IsGoingBack,
    PauseDurationBeforeGoingBack: this._behaviorData.PauseDurationBeforeGoingBack,
  ...
  updateFromNetworkSyncData(networkSyncData) {
    ...
    if (networkSyncData.props.FlipXToGoBack !== undefined)
      this._behaviorData.FlipXToGoBack = networkSyncData.props.FlipXToGoBack;
    if (networkSyncData.props.FlipYToGoBack !== undefined)
      this._behaviorData.FlipYToGoBack = networkSyncData.props.FlipYToGoBack;
    ...
    if (networkSyncData.props.Target !== undefined)
      this._behaviorData.Target = networkSyncData.props.Target;
    if (networkSyncData.props.Origin !== undefined)
      this._behaviorData.Origin = networkSyncData.props.Origin;
    ...
    if (networkSyncData.props.ShouldGoBack !== undefined)
      this._behaviorData.ShouldGoBack = networkSyncData.props.ShouldGoBack;
    if (networkSyncData.props.ShouldLoop !== undefined)
      this._behaviorData.ShouldLoop = networkSyncData.props.ShouldLoop;
    if (networkSyncData.props.RepetitionDoneCount !== undefined)
      this._behaviorData.RepetitionDoneCount = networkSyncData.props.RepetitionDoneCount;
    if (networkSyncData.props.IsGoingBack !== undefined)
      this._behaviorData.IsGoingBack = networkSyncData.props.IsGoingBack;
    if (networkSyncData.props.PauseDurationBeforeGoingBack !== undefined)
      this._behaviorData.PauseDurationBeforeGoingBack = networkSyncData.props.PauseDurationBeforeGoingBack;
...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement.prototype.UpdatePositionContext.userFunc0xb14a78 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement.prototype.UpdatePositionContext.userFunc0xb14a78(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement.prototype.DrawDebugContext.userFunc0xb14a78 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const behaviorName = eventsFunctionContext.getBehaviorName("Behavior");
...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement.prototype.DrawDebugContext.userFunc0xb14a78(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement.prototype.SetTransformationContext.userFunc0xb4ccd8 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const behaviorName = eventsFunctionContext.getBehaviorName("Behavior");
const behavior = objects[0].getBehavior(behaviorName);
...
gdjs.evtsExt__CurvedMovement__TweenPathMovement.TweenPathMovement.prototype.SetTransformationContext.userFunc0xb4ccd8(runtimeScene, objects, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
